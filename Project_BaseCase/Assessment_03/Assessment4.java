...
class Order{
    ...
    Order(String name, double price, int quantity){
        if(price<=0){
            throw new IllegalArgumentException("Error: Unit Price must greater then zero. Skipping this Item");
        }
        if(quantity<=0){
...
public class Assessment4 {
    ...
    public static void main(String[] args){
        ...
        sc.nextLine();
        if(n>5){
            System.out.println("Error: You Entered More then 5! Item Now It Set to 5");
            n=5;
        }
